...
<style scoped>
.site-agent-page{display:flex;flex-direction:column;gap:16px;max-width:1280px;margin:0 auto;padding:18px 20px 28px}.page-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.page-heading h2{font-size:22px;margin:2px 0 5px}.page-heading p{max-width:760px;color:var(--muted);font-size:13px}.eyebrow{font:700 10px/1 var(--font-mono);letter-spacing:.16em;color:var(--brand-text)!important}.runtime-badge{display:flex;align-items:center;gap:7px;padding:7px 11px;border:1px solid var(--line);border-radius:999px;background:var(--surface);font-size:12px;white-space:nowrap}.status-dot{width:8px;height:8px;border-radius:50%;background:var(--dim)}.runtime-badge.ready{color:var(--success)}.runtime-badge.ready .status-dot{background:var(--success);box-shadow:0 0 0 4px color-mix(in srgb,var(--success) 12%,transparent)}.runtime-badge.failed{color:var(--danger)}.runtime-badge.failed .status-dot{background:var(--danger)}.panel,.metric-card{border:1px solid var(--line);border-radius:var(--radius-card);background:var(--surface)}.loading-state{padding:40px;text-align:center;color:var(--muted)}.overview-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.metric-card{display:grid;gap:4px;padding:14px 16px}.metric-card span,.metric-card small{font-size:11px;color:var(--muted)}.metric-card strong{overflow:hidden;text-overflow:ellipsis;font:600 14px/1.45 var(--font-mono)}.settings-layout{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(300px,.75fr);gap:14px}.panel{padding:17px}.panel-title{display:flex;justify-content:space-between;gap:18px;padding-bottom:14px;border-bottom:1px solid var(--line)}.panel h3{font-size:15px;margin:0 0 5px}.panel p{font-size:12px;color:var(--muted)}.switch-row{display:flex;align-items:center;gap:7px;font-size:12px;font-weight:600;white-space:nowrap}.form-grid,.stcp-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:16px}.form-grid label,.stcp-grid label,.secret-fields label{display:grid;gap:5px}.form-grid label>span,.stcp-grid label>span,.secret-fields label>span{font-size:11px;color:var(--muted)}input,select{width:100%;height:34px;padding:0 9px;border:1px solid var(--control-border);border-radius:5px;background:var(--field-bg);color:var(--text);font:12px var(--font-body)}.check-field{display:flex!important;grid-column:1/-1;align-items:center;grid-template-columns:auto 1fr!important}.check-field input,.switch-row input{width:16px;height:16px}.actions{display:flex;gap:8px;margin-top:18px}.side-stack{display:grid;gap:14px;align-content:start}.credential-panel>.btn{margin-top:14px}.secret-fields{display:grid;gap:10px;margin-top:15px;padding-top:15px;border-top:1px solid var(--line)}.workflow-panel ol{display:grid;gap:9px;margin:13px 0 14px;padding-left:20px;color:var(--muted);font-size:12px}.workflow-panel code{display:block;overflow:auto;padding:9px;border-radius:5px;background:var(--surface-muted);font:11px var(--font-mono)}@media(max-width:900px){.overview-grid{grid-template-columns:1fr}.settings-layout{grid-template-columns:1fr}}@media(max-width:620px){.page-heading,.panel-title{flex-direction:column}.form-grid,.stcp-grid{grid-template-columns:1fr}.site-agent-page{padding:14px 12px}}
</style>
